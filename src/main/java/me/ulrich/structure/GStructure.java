...
import me.ulrich.structure.BlockEntityTag.*;
import me.ulrich.structure.nbt.io.NBTUtil;
import me.ulrich.structure.nbt.io.NamedTag;
...
public class GStructure {
	...
	public void read(File file) {
		if (file.exists()) {
			...
			if(nbt_t.getListTag("entities")!=null) {
